...
<td align='center'>  
<a href='media.php?module=daftaritem&act=ubah&id=$data[id_jenis]'>
...
<a href="<?php echo "$aksi?module=daftaritem&act=hapus&id=$data[id_jenis]"; ?>" onclick="return confirm('Apakah Anda Yakin Menghapus data Ini?')">
...
<form role="form" method="POST" action='<?php echo"$aksi?module=daftaritem&act=tambah"; ?>' enctype='multipart/form-data'>
              ...
              <!-- /.form group -->
				...
				<div class="form-group">
                  <label>Nama </label>
                 <input type="text" placeholder="" class="form-control" name="nama_jenis" value=''>
                </div>
...
$stmt = $db->query("SELECT * FROM jenis_cucian a where a.id_jenis='$_GET[id]' ");
...
<form role="form" method="POST" action='<?php echo"$aksi?module=daftaritem&act=ubah"; ?>' enctype='multipart/form-data'>
	...
	<input type="hidden" name="id_jenis" value="<?php echo $rowa['id_jenis']; ?>"/>
              ...
              <!-- /.form group -->
				...
				<div class="form-group">
                  <label>Nama </label>
                 <input type="text" placeholder="" class="form-control" name="nama_jenis" value='<?php echo $rowa['nama_jenis']; ?>'>
                </div>
