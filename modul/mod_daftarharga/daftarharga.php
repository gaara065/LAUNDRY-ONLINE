	   ...
	   echo "
	         <tr class='gradeX' >
													...
													<td>$data[nama]</td>
														<td>
															";
													echo rupiah2($data['harga']);
												echo "</td><td>$data[satuan]</td>
...
<form role="form" method="POST" action='<?php echo"$aksi?module=daftarharga&act=tambah"; ?>' enctype='multipart/form-data'>
              ...
              <!-- /.form group -->
				...
				<div class="form-group">
                  <label>Harga</label>
                 <input type="text" placeholder="" class="form-control" name="harga" id='angka3'>
                </div>
...
<form role="form" method="POST" action='<?php echo"$aksi?module=daftarharga&act=ubah"; ?>' enctype='multipart/form-data'>
	...
	<input type="hidden" name="id_cucian" value="<?php echo $rowa['id_cucian']; ?>"/>
              ...
              <!-- /.form group -->
				...
				<div class="form-group">
                  <label>Harga</label>
                 <input type="text" placeholder="" class="form-control" name="harga" id='angka3' value='<?php echo $rowa['harga']; ?>'>
                </div>
