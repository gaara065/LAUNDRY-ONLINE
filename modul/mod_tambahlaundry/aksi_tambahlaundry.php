...
$result = $db->exec("INSERT INTO transaksi( id_toko,  tanggal, jam) 

VALUES('$_POST[id_toko]', '$today', '$jam')");
...
if ($_POST['submit1']<>'')
 ...
 header('location:../../media.php?module=tambahlaundry&act=pelanggan&id='.$_POST['id_transaksi'].'&stat=1');
	...
	{
	$affected_rows = $db->exec("UPDATE transaksi SET id_pelanggan = '$row[id_pelanggan]', cttn= '$_POST[cttn]', tanggal_selesai='$tgla', parfum='$_POST[parfum]' WHERE transaksi.id_transaksi = '$_POST[id_transaksi]'");
...
$affected_rows = $db->exec("UPDATE transaksi SET id_pelanggan = '$insertId' , cttn= '$_POST[cttn]', tanggal_selesai='$tgla', parfum='$_POST[parfum]' WHERE transaksi.id_transaksi = '$_POST[id_transaksi]'");
