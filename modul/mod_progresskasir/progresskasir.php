...
$_GET['limit'] = isset($_GET['limit']) ? $_GET['limit'] : '';
...
<div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1">Baru</a></li>
              <li><a href="media.php?module=progresskasir&act=tab2" >Dikerjakan</a></li>
              <li><a href="media.php?module=progresskasir&act=tab3" >Selesai</a></li>
...
{
?>
 <a href='media.php?module=progresskasir&limit=1'> <button type="button" class="btn btn-warning btn-sm" >
                 Tampilkan Semua</button></a>  
...
$pizza  = $data['tanggal'];
	   ...
	   echo "
			...
			<br/>$pizza $data[jam]<br/> $data[nama_pelanggan]
			<br/>$data[hp]</td>
...
<div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                  <li ><a href="media.php?module=progresskasir">Baru</a></li>
              <li class="active"><a href="#" >Dikerjakan</a></li>
              <li><a href="media.php?module=progresskasir&act=tab3" >Selesai</a></li>
...
function openWin() {
	alert ("Selesai?");
 // myWindow = window.open("modul/mod_progresskasir/sms.php?id=<?php echo "$dataid";?>", "_blank", "width=300, height=500");
