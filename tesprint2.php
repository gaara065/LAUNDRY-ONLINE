...
Nota Pesanan Pelanggan 
	...
	--------------------------------------			
                    <div class="invoice-title" align="left">
                            Nota #  <?php echo $data8['nota']; echo "&nbsp;&nbsp;"; echo $data8['jam']; ?>
                    </div>
...
--------------------------------------	
       <div class="invoice-title" align="center">
	   	   	  <div  align="left">
                       *parfum : <?php echo $data8['parfum']; ?>
                    </div>
					--------------------------------------	
	   	  <div  align="left">
                       *catatan : <?php echo $data8['cttn']; ?>
                    </div>
					--------------------------------------	
